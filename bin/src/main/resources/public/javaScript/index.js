...
/*
importar todos os componentes e funções
*/
...
const heroBanner = function({results: movieList}){
    ...
    for(const [index, movie] of movieList.entries()){
        ...
        <img src="${imagemBaseURL}w1280${backdrop_path}" alt="${title}" loading=${index === 0 ? "eager" : "lazy"
        }>
            ...
            <a href="./detalhe.html" class="btn" onclick="getMovieDetail(${id})">
        ...
        <img src="${imagemBaseURL}w154${poster_path}" alt="Slide to ${title}" loading="lazy" draggable="false" class="img-cover">
        `;
...
const addHeroSlide = function(){
    ...
    let lastSliderItem = sliderItems[7];
